	...
	define CHE_TABLES #bb00	; адрес, с которого начинаютс€ таблицы плеера (1к)
...
start	di : ld sp, $-2
	...
	; инициаци€ плеера
	ld a, %11000000		; экран #c000 / нулева€ стартова€ €ркость
...
fin_outer	push bc
	...
	ld b, #04		; внутри каждой интерации прокручиваем N раз анимацию дл€ замедлени€ эффекта
...
_player_stopped	xor a : out (#fe), a
	...
	; два цвета, раздельные дл€ каждого экрана
COLOR1	db #42
COLOR2	db #03
